            ...
            <section id="home" className="h-screen bg-black text-white flex items-center">
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl">
                        <h1 className="text-5xl font-bold mb-4">Nishant Pawar</h1>
                        <p className="text-xl text-blue-400">Full Stack Developer</p>
                        <p className="mt-6 text-gray-300">Transforming ideas into elegant digital solutions</p>
                    </div>
                    <div className="pt-8 space-y-4">
                        <div className="flex items-center space-x-2 text-gray-300">
                            <Mail size={20} className="text-blue-400" />
                            <span>nishantpawar393@gmail.com</span>
                        </div>
                        <div className="flex items-center space-x-2 text-gray-300">
                            <Phone size={20} className="text-blue-400" />
                            <span>+91 9881821001</span>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <p className="text-gray-600">React, HTML5, CSS3, JavaScript</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="bg-gray-50 rounded-lg shadow-lg p-6">
                            <h3 className="font-bold text-xl mb-4">Project 1</h3>
                            <p className="text-gray-600">A brief description of your project goes here.</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg shadow-lg p-6">
                            <h3 className="font-bold text-xl mb-4">Project 2</h3>
                            <p className="text-gray-600">A brief description of your project goes here.</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg shadow-lg p-6">
                            <h3 className="font-bold text-xl mb-4">Project 3</h3>
                            <p className="text-gray-600">A brief description of your project goes here.</p>
                        </div>
                    </div>
                </div>
